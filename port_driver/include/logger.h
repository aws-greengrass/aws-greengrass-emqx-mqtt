...
enum log_subject {
    ...
    WRITE_CONFIG_SUBJECT = AWS_LOG_SUBJECT_BEGIN_RANGE(104),
    CONFIG_SUBSCRIBER_SUBJECT = AWS_LOG_SUBJECT_BEGIN_RANGE(105),
    GET_CONFIG_SUBJECT = AWS_LOG_SUBJECT_BEGIN_RANGE(106),
};
