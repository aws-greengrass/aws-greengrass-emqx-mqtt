...
payloadObject.WithString("topic", m_topic.value());
            ...
            void MessageContext::s_loadFromJsonView(MessageContext &messageContext, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
payloadObject.WithDouble("cpus", m_cpus.value());
            ...
            void SystemResourceLimits::s_loadFromJsonView(SystemResourceLimits &systemResourceLimits, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
payloadObject.WithString("deploymentId", m_deploymentId.value());
            ...
            void ValidateConfigurationUpdateEvent::s_loadFromJsonView(ValidateConfigurationUpdateEvent &validateConfigurationUpdateEvent, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("configuration")) {
validateConfigurationUpdateEvent.m_configuration = Aws::Crt::Optional<Aws::Crt::JsonObject>(jsonView.GetJsonObject("configuration").Materialize());
                }
                if (jsonView.ValueExists("deploymentId")) {
validateConfigurationUpdateEvent.m_deploymentId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<ValidateConfigurationUpdateEvent> shape(
                    Aws::Crt::New<ValidateConfigurationUpdateEvent>(allocator), ValidateConfigurationUpdateEvent::s_customDeleter);
                shape->m_allocator = allocator;
...
if (jsonView.GetString("payload").size() > 0) {
                        mQTTMessage.m_payload = Aws::Crt::Optional<Aws::Crt::Vector<uint8_t>>(Aws::Crt::Base64Decode(jsonView.GetString("payload")));
                    }
                }
            }
...
Aws::Crt::JsonObject keyPath;
            ...
            void ConfigurationUpdateEvent::s_loadFromJsonView(ConfigurationUpdateEvent &configurationUpdateEvent, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
configurationUpdateEvent.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
...
payloadObject.WithString("deploymentId", m_deploymentId.value());
            ...
            void PostComponentUpdateEvent::s_loadFromJsonView(PostComponentUpdateEvent &postComponentUpdateEvent, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("deploymentId")) {
postComponentUpdateEvent.m_deploymentId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
                }
            }
...
payloadObject.WithBool("isGgcRestarting", m_isGgcRestarting.value());
            ...
            void PreComponentUpdateEvent::s_loadFromJsonView(PreComponentUpdateEvent &preComponentUpdateEvent, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("deploymentId")) {
preComponentUpdateEvent.m_deploymentId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
                }
                if (jsonView.ValueExists("isGgcRestarting")) {
preComponentUpdateEvent.m_isGgcRestarting = Aws::Crt::Optional<bool>(jsonView.GetBool("isGgcRestarting"));
                }
            }
...
Aws::Crt::JsonObject cACertificates;
            ...
            void CertificateUpdate::s_loadFromJsonView(CertificateUpdate &certificateUpdate, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
certificateUpdate.m_certificate = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("certificate"));
                }
...
Aws::Crt::JsonObject messageContextValue;
            ...
            void BinaryMessage::s_loadFromJsonView(BinaryMessage &binaryMessage, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
if (jsonView.GetString("message").size() > 0) {
                        binaryMessage.m_message = Aws::Crt::Optional<Aws::Crt::Vector<uint8_t>>(Aws::Crt::Base64Decode(jsonView.GetString("message")));
                    }
                }
...
Aws::Crt::JsonObject messageContextValue;
            ...
            {
                if (jsonView.ValueExists("message")) {
jsonMessage.m_message = Aws::Crt::Optional<Aws::Crt::JsonObject>(jsonView.GetJsonObject("message").Materialize());
                }
                if (jsonView.ValueExists("context")) {
...
payloadObject.WithString("password", m_password.value());
            ...
            void MQTTCredential::s_loadFromJsonView(MQTTCredential &mQTTCredential, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
mQTTCredential.m_certificatePem = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("certificatePem"));
                }
...
runWithInfo.m_systemResourceLimits = SystemResourceLimits();
                    SystemResourceLimits::s_loadFromJsonView(runWithInfo.m_systemResourceLimits.value(), jsonView.GetJsonObject("systemResourceLimits"));
                }
            }
...
payloadObject.WithString("clientDeviceCertificate", m_clientDeviceCertificate.value());
            ...
            void ClientDeviceCredential::s_loadFromJsonView(ClientDeviceCredential &clientDeviceCredential, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("clientDeviceCertificate")) {
clientDeviceCredential.m_clientDeviceCertificate = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("clientDeviceCertificate"));
            ...
            void ValidateConfigurationUpdateEvents::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                if (m_chosenMember == TAG_VALIDATE_CONFIGURATION_UPDATE_EVENT && m_validateConfigurationUpdateEvent.has_value()) {
Aws::Crt::JsonObject validateConfigurationUpdateEventValue;
                    ...
                    payloadObject.WithObject("validateConfigurationUpdateEvent", std::move(validateConfigurationUpdateEventValue));
                }
            }

            void ValidateConfigurationUpdateEvents::s_loadFromJsonView(ValidateConfigurationUpdateEvents &validateConfigurationUpdateEvents, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("validateConfigurationUpdateEvent")) {
validateConfigurationUpdateEvents.m_validateConfigurationUpdateEvent = ValidateConfigurationUpdateEvent();
                    ValidateConfigurationUpdateEvent::s_loadFromJsonView(validateConfigurationUpdateEvents.m_validateConfigurationUpdateEvent.value(), jsonView.GetJsonObject("validateConfigurationUpdateEvent"));
                    validateConfigurationUpdateEvents.m_chosenMember = TAG_VALIDATE_CONFIGURATION_UPDATE_EVENT;
                }
            }

            ValidateConfigurationUpdateEvents& ValidateConfigurationUpdateEvents::operator=(const ValidateConfigurationUpdateEvents& objectToCopy) noexcept
            {
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<ValidateConfigurationUpdateEvents> shape(
                    Aws::Crt::New<ValidateConfigurationUpdateEvents>(allocator), ValidateConfigurationUpdateEvents::s_customDeleter);
                shape->m_allocator = allocator;
...
Aws::Crt::JsonObject binaryMessageValue;
            ...
            void SubscriptionResponseMessage::s_loadFromJsonView(SubscriptionResponseMessage &subscriptionResponseMessage, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("jsonMessage")) {
subscriptionResponseMessage.m_jsonMessage = JsonMessage();
                    JsonMessage::s_loadFromJsonView(subscriptionResponseMessage.m_jsonMessage.value(), jsonView.GetJsonObject("jsonMessage"));
...
subscriptionResponseMessage.m_binaryMessage = BinaryMessage();
                    BinaryMessage::s_loadFromJsonView(subscriptionResponseMessage.m_binaryMessage.value(), jsonView.GetJsonObject("binaryMessage"));
                    subscriptionResponseMessage.m_chosenMember = TAG_BINARY_MESSAGE;
                }
            }

            SubscriptionResponseMessage& SubscriptionResponseMessage::operator=(const SubscriptionResponseMessage& objectToCopy) noexcept
            {
...
Aws::Crt::JsonObject mQTTMessageValue;
            ...
            void IoTCoreMessage::s_loadFromJsonView(IoTCoreMessage &ioTCoreMessage, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
...
Aws::Crt::JsonObject configurationUpdateEventValue;
            ...
            void ConfigurationUpdateEvents::s_loadFromJsonView(ConfigurationUpdateEvents &configurationUpdateEvents, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
configurationUpdateEvents.m_configurationUpdateEvent = ConfigurationUpdateEvent();
                    ConfigurationUpdateEvent::s_loadFromJsonView(configurationUpdateEvents.m_configurationUpdateEvent.value(), jsonView.GetJsonObject("configurationUpdateEvent"));
                    configurationUpdateEvents.m_chosenMember = TAG_CONFIGURATION_UPDATE_EVENT;
                }
            }

            ConfigurationUpdateEvents& ConfigurationUpdateEvents::operator=(const ConfigurationUpdateEvents& objectToCopy) noexcept
            {
...
Aws::Crt::JsonObject postComponentUpdateEventValue;
            ...
            void ComponentUpdatePolicyEvents::s_loadFromJsonView(ComponentUpdatePolicyEvents &componentUpdatePolicyEvents, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("preUpdateEvent")) {
componentUpdatePolicyEvents.m_preUpdateEvent = PreComponentUpdateEvent();
                    PreComponentUpdateEvent::s_loadFromJsonView(componentUpdatePolicyEvents.m_preUpdateEvent.value(), jsonView.GetJsonObject("preUpdateEvent"));
...
componentUpdatePolicyEvents.m_postUpdateEvent = PostComponentUpdateEvent();
                    PostComponentUpdateEvent::s_loadFromJsonView(componentUpdatePolicyEvents.m_postUpdateEvent.value(), jsonView.GetJsonObject("postUpdateEvent"));
                    componentUpdatePolicyEvents.m_chosenMember = TAG_POST_UPDATE_EVENT;
                }
            }

            ComponentUpdatePolicyEvents& ComponentUpdatePolicyEvents::operator=(const ComponentUpdatePolicyEvents& objectToCopy) noexcept
            {
...
Aws::Crt::JsonObject certificateUpdateValue;
            ...
            void CertificateUpdateEvent::s_loadFromJsonView(CertificateUpdateEvent &certificateUpdateEvent, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("certificateUpdate")) {
certificateUpdateEvent.m_certificateUpdate = CertificateUpdate();
                    CertificateUpdate::s_loadFromJsonView(certificateUpdateEvent.m_certificateUpdate.value(), jsonView.GetJsonObject("certificateUpdate"));
...
payloadObject.WithString("certificateType", m_certificateType.value());
            ...
            void CertificateOptions::s_loadFromJsonView(CertificateOptions &certificateOptions, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("certificateType")) {
certificateOptions.m_certificateType = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("certificateType"));
                }
            }
            ...
            {
                if (!m_certificateType.has_value()) return Aws::Crt::Optional<CertificateType>();
...
payloadObject.WithString("message", m_message.value());
            ...
            void ConfigurationValidityReport::s_loadFromJsonView(ConfigurationValidityReport &configurationValidityReport, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("status")) {
configurationValidityReport.m_status = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("status"));
                }
                if (jsonView.ValueExists("deploymentId")) {
configurationValidityReport.m_deploymentId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
                }
                if (jsonView.ValueExists("message")) {
configurationValidityReport.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
                }
            }
            ...
            {
                if (!m_status.has_value()) return Aws::Crt::Optional<ConfigurationValidityStatus>();
...
Aws::Crt::JsonObject binaryMessageValue;
            ...
            void PublishMessage::s_loadFromJsonView(PublishMessage &publishMessage, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("jsonMessage")) {
publishMessage.m_jsonMessage = JsonMessage();
                    JsonMessage::s_loadFromJsonView(publishMessage.m_jsonMessage.value(), jsonView.GetJsonObject("jsonMessage"));
                    publishMessage.m_chosenMember = TAG_JSON_MESSAGE;
                }
                else if (jsonView.ValueExists("binaryMessage")) {
publishMessage.m_binaryMessage = BinaryMessage();
                    BinaryMessage::s_loadFromJsonView(publishMessage.m_binaryMessage.value(), jsonView.GetJsonObject("binaryMessage"));
...
if (jsonView.GetString("secretBinary").size() > 0) {
                        secretValue.m_secretBinary = Aws::Crt::Optional<Aws::Crt::Vector<uint8_t>>(Aws::Crt::Base64Decode(jsonView.GetString("secretBinary")));
                    }
...
payloadObject.WithString("status", m_status.value());
            ...
            void LocalDeployment::s_loadFromJsonView(LocalDeployment &localDeployment, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("deploymentId")) {
localDeployment.m_deploymentId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
                }
                if (jsonView.ValueExists("status")) {
localDeployment.m_status = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("status"));
            ...
            {
                if (!m_status.has_value()) return Aws::Crt::Optional<DeploymentStatus>();
...
payloadObject.WithObject("configuration", m_configuration.value());
            ...
            void ComponentDetails::s_loadFromJsonView(ComponentDetails &componentDetails, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
componentDetails.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
...
componentDetails.m_state = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("state"));
                ...
                if (jsonView.ValueExists("configuration")) {
componentDetails.m_configuration = Aws::Crt::Optional<Aws::Crt::JsonObject>(jsonView.GetJsonObject("configuration").Materialize());
                }
            }
            ...
            {
                if (!m_state.has_value()) return Aws::Crt::Optional<LifecycleState>();
...
Aws::Crt::JsonObject mQTTCredentialValue;
            ...
            void CredentialDocument::s_loadFromJsonView(CredentialDocument &credentialDocument, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("mqttCredential")) {
credentialDocument.m_mqttCredential = MQTTCredential();
                    MQTTCredential::s_loadFromJsonView(credentialDocument.m_mqttCredential.value(), jsonView.GetJsonObject("mqttCredential"));
            ...
            void VerifyClientDeviceIdentityResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
...
payloadObject.WithBool("isValidClientDevice", m_isValidClientDevice.value());
            ...
            void VerifyClientDeviceIdentityResponse::s_loadFromJsonView(VerifyClientDeviceIdentityResponse &verifyClientDeviceIdentityResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("isValidClientDevice")) {
verifyClientDeviceIdentityResponse.m_isValidClientDevice = Aws::Crt::Optional<bool>(jsonView.GetBool("isValidClientDevice"));
                }
            }



            const char* VerifyClientDeviceIdentityResponse::MODEL_NAME = "aws.greengrass#VerifyClientDeviceIdentityResponse";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<VerifyClientDeviceIdentityResponse> shape(
                    Aws::Crt::New<VerifyClientDeviceIdentityResponse>(allocator), VerifyClientDeviceIdentityResponse::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void VerifyClientDeviceIdentityRequest::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
...
Aws::Crt::JsonObject clientDeviceCredentialValue;
            ...
            void VerifyClientDeviceIdentityRequest::s_loadFromJsonView(VerifyClientDeviceIdentityRequest &verifyClientDeviceIdentityRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("credential")) {
verifyClientDeviceIdentityRequest.m_credential = ClientDeviceCredential();
                    ClientDeviceCredential::s_loadFromJsonView(verifyClientDeviceIdentityRequest.m_credential.value(), jsonView.GetJsonObject("credential"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<VerifyClientDeviceIdentityRequest> shape(
                    Aws::Crt::New<VerifyClientDeviceIdentityRequest>(allocator), VerifyClientDeviceIdentityRequest::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithString("message", m_message.value());
            ...
            void InvalidTokenError::s_loadFromJsonView(InvalidTokenError &invalidTokenError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
invalidTokenError.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
            ...
            void ValidateAuthorizationTokenResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
...
payloadObject.WithBool("isValid", m_isValid.value());
            ...
            void ValidateAuthorizationTokenResponse::s_loadFromJsonView(ValidateAuthorizationTokenResponse &validateAuthorizationTokenResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
validateAuthorizationTokenResponse.m_isValid = Aws::Crt::Optional<bool>(jsonView.GetBool("isValid"));
            ...
            const char* ValidateAuthorizationTokenResponse::MODEL_NAME = "aws.greengrass#ValidateAuthorizationTokenResponse";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<ValidateAuthorizationTokenResponse> shape(
                    Aws::Crt::New<ValidateAuthorizationTokenResponse>(allocator), ValidateAuthorizationTokenResponse::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void ValidateAuthorizationTokenRequest::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
...
payloadObject.WithString("token", m_token.value());
            ...
            void ValidateAuthorizationTokenRequest::s_loadFromJsonView(ValidateAuthorizationTokenRequest &validateAuthorizationTokenRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("token")) {
validateAuthorizationTokenRequest.m_token = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("token"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<ValidateAuthorizationTokenRequest> shape(
                    Aws::Crt::New<ValidateAuthorizationTokenRequest>(allocator), ValidateAuthorizationTokenRequest::s_customDeleter);
                shape->m_allocator = allocator;
...
if (m_payload.value().size() > 0) {
            ...
            void UpdateThingShadowResponse::s_loadFromJsonView(UpdateThingShadowResponse &updateThingShadowResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("payload")) {
if (jsonView.GetString("payload").size() > 0) {
                        updateThingShadowResponse.m_payload = Aws::Crt::Optional<Aws::Crt::Vector<uint8_t>>(Aws::Crt::Base64Decode(jsonView.GetString("payload")));
                    }
                }
            }
...
if (m_payload.value().size() > 0) {
            ...
            void UpdateThingShadowRequest::s_loadFromJsonView(UpdateThingShadowRequest &updateThingShadowRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("thingName")) {
updateThingShadowRequest.m_thingName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("thingName"));
                }
                if (jsonView.ValueExists("shadowName")) {
updateThingShadowRequest.m_shadowName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("shadowName"));
                }
                if (jsonView.ValueExists("payload")) {
if (jsonView.GetString("payload").size() > 0) {
                        updateThingShadowRequest.m_payload = Aws::Crt::Optional<Aws::Crt::Vector<uint8_t>>(Aws::Crt::Base64Decode(jsonView.GetString("payload")));
                    }
                }
            }
            ...
            void UpdateStateResponse::s_loadFromJsonView(UpdateStateResponse &updateStateResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
payloadObject.WithString("state", m_state.value());
            ...
            void UpdateStateRequest::s_loadFromJsonView(UpdateStateRequest &updateStateRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("state")) {
updateStateRequest.m_state = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("state"));
            ...
            {
                if (!m_state.has_value()) return Aws::Crt::Optional<ReportedLifecycleState>();
                if (m_state.value() == Aws::Crt::String("RUNNING")) {
...
payloadObject.WithString("message", m_message.value());
            ...
            void FailedUpdateConditionCheckError::s_loadFromJsonView(FailedUpdateConditionCheckError &failedUpdateConditionCheckError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
failedUpdateConditionCheckError.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<FailedUpdateConditionCheckError> shape(
                    Aws::Crt::New<FailedUpdateConditionCheckError>(allocator), FailedUpdateConditionCheckError::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithString("message", m_message.value());
            ...
            void ConflictError::s_loadFromJsonView(ConflictError &conflictError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
conflictError.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
            ...
            void UpdateConfigurationResponse::s_loadFromJsonView(UpdateConfigurationResponse &updateConfigurationResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
payloadObject.WithObject("valueToMerge", m_valueToMerge.value());
            ...
            void UpdateConfigurationRequest::s_loadFromJsonView(UpdateConfigurationRequest &updateConfigurationRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("keyPath")) {
...
updateConfigurationRequest.m_timestamp = Aws::Crt::Optional<Aws::Crt::DateTime>(Aws::Crt::DateTime(jsonView.GetDouble("timestamp")));
                }
                if (jsonView.ValueExists("valueToMerge")) {
updateConfigurationRequest.m_valueToMerge = Aws::Crt::Optional<Aws::Crt::JsonObject>(jsonView.GetJsonObject("valueToMerge").Materialize());
                }
            }
            ...
            void SubscribeToValidateConfigurationUpdatesResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                (void)payloadObject;
            }

            void SubscribeToValidateConfigurationUpdatesResponse::s_loadFromJsonView(SubscribeToValidateConfigurationUpdatesResponse &subscribeToValidateConfigurationUpdatesResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> SubscribeToValidateConfigurationUpdatesResponse::s_allocateFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) noexcept
            {
                Aws::Crt::String payload = {stringView.begin(), stringView.end()};
                ...
                Aws::Crt::ScopedResource<SubscribeToValidateConfigurationUpdatesResponse> shape(
                    Aws::Crt::New<SubscribeToValidateConfigurationUpdatesResponse>(allocator), SubscribeToValidateConfigurationUpdatesResponse::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SubscribeToValidateConfigurationUpdatesResponse::s_customDeleter(SubscribeToValidateConfigurationUpdatesResponse *shape) noexcept
            {
                AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
            }

            void SubscribeToValidateConfigurationUpdatesRequest::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                (void)payloadObject;
            }

            void SubscribeToValidateConfigurationUpdatesRequest::s_loadFromJsonView(SubscribeToValidateConfigurationUpdatesRequest &subscribeToValidateConfigurationUpdatesRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
            ...
            const char* SubscribeToValidateConfigurationUpdatesRequest::MODEL_NAME = "aws.greengrass#SubscribeToValidateConfigurationUpdatesRequest";
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> SubscribeToValidateConfigurationUpdatesRequest::s_allocateFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) noexcept
            {
                Aws::Crt::String payload = {stringView.begin(), stringView.end()};
                ...
                Aws::Crt::ScopedResource<SubscribeToValidateConfigurationUpdatesRequest> shape(
                    Aws::Crt::New<SubscribeToValidateConfigurationUpdatesRequest>(allocator), SubscribeToValidateConfigurationUpdatesRequest::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SubscribeToValidateConfigurationUpdatesRequest::s_customDeleter(SubscribeToValidateConfigurationUpdatesRequest *shape) noexcept
            {
                AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
            }
...
payloadObject.WithString("topicName", m_topicName.value());
            ...
            void SubscribeToTopicResponse::s_loadFromJsonView(SubscribeToTopicResponse &subscribeToTopicResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("topicName")) {
subscribeToTopicResponse.m_topicName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("topicName"));
                }
            }
...
payloadObject.WithString("receiveMode", m_receiveMode.value());
            ...
            void SubscribeToTopicRequest::s_loadFromJsonView(SubscribeToTopicRequest &subscribeToTopicRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("topic")) {
...
subscribeToTopicRequest.m_receiveMode = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("receiveMode"));
                }
            }
            ...
            {
                if (!m_receiveMode.has_value()) return Aws::Crt::Optional<ReceiveMode>();
            ...
            void SubscribeToIoTCoreResponse::s_loadFromJsonView(SubscribeToIoTCoreResponse &subscribeToIoTCoreResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
payloadObject.WithString("qos", m_qos.value());
            ...
            void SubscribeToIoTCoreRequest::s_loadFromJsonView(SubscribeToIoTCoreRequest &subscribeToIoTCoreRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("topicName")) {
subscribeToIoTCoreRequest.m_topicName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("topicName"));
                }
...
subscribeToIoTCoreRequest.m_qos = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("qos"));
            ...
            {
                if (!m_qos.has_value()) return Aws::Crt::Optional<QOS>();
            ...
            void SubscribeToConfigurationUpdateResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                (void)payloadObject;
            }

            void SubscribeToConfigurationUpdateResponse::s_loadFromJsonView(SubscribeToConfigurationUpdateResponse &subscribeToConfigurationUpdateResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
            ...
            const char* SubscribeToConfigurationUpdateResponse::MODEL_NAME = "aws.greengrass#SubscribeToConfigurationUpdateResponse";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<SubscribeToConfigurationUpdateResponse> shape(
                    Aws::Crt::New<SubscribeToConfigurationUpdateResponse>(allocator), SubscribeToConfigurationUpdateResponse::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SubscribeToConfigurationUpdateResponse::s_customDeleter(SubscribeToConfigurationUpdateResponse *shape) noexcept
            {
                AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
            }

            void SubscribeToConfigurationUpdateRequest::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                if (m_componentName.has_value()) {
payloadObject.WithString("componentName", m_componentName.value());
                }
...
Aws::Crt::JsonObject keyPath;
            ...
            void SubscribeToConfigurationUpdateRequest::s_loadFromJsonView(SubscribeToConfigurationUpdateRequest &subscribeToConfigurationUpdateRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
subscribeToConfigurationUpdateRequest.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
                if (jsonView.ValueExists("keyPath")) {
subscribeToConfigurationUpdateRequest.m_keyPath = Aws::Crt::Vector<Aws::Crt::String>();
            ...
            const char* SubscribeToConfigurationUpdateRequest::MODEL_NAME = "aws.greengrass#SubscribeToConfigurationUpdateRequest";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<SubscribeToConfigurationUpdateRequest> shape(
                    Aws::Crt::New<SubscribeToConfigurationUpdateRequest>(allocator), SubscribeToConfigurationUpdateRequest::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SubscribeToConfigurationUpdateRequest::s_customDeleter(SubscribeToConfigurationUpdateRequest *shape) noexcept
            {
                AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
            }

            void SubscribeToComponentUpdatesResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                (void)payloadObject;
            }

            void SubscribeToComponentUpdatesResponse::s_loadFromJsonView(SubscribeToComponentUpdatesResponse &subscribeToComponentUpdatesResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
            ...
            const char* SubscribeToComponentUpdatesResponse::MODEL_NAME = "aws.greengrass#SubscribeToComponentUpdatesResponse";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<SubscribeToComponentUpdatesResponse> shape(
                    Aws::Crt::New<SubscribeToComponentUpdatesResponse>(allocator), SubscribeToComponentUpdatesResponse::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SubscribeToComponentUpdatesRequest::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                (void)payloadObject;
            }

            void SubscribeToComponentUpdatesRequest::s_loadFromJsonView(SubscribeToComponentUpdatesRequest &subscribeToComponentUpdatesRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
            ...
            const char* SubscribeToComponentUpdatesRequest::MODEL_NAME = "aws.greengrass#SubscribeToComponentUpdatesRequest";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<SubscribeToComponentUpdatesRequest> shape(
                    Aws::Crt::New<SubscribeToComponentUpdatesRequest>(allocator), SubscribeToComponentUpdatesRequest::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SubscribeToCertificateUpdatesResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                (void)payloadObject;
            }

            void SubscribeToCertificateUpdatesResponse::s_loadFromJsonView(SubscribeToCertificateUpdatesResponse &subscribeToCertificateUpdatesResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
            ...
            const char* SubscribeToCertificateUpdatesResponse::MODEL_NAME = "aws.greengrass#SubscribeToCertificateUpdatesResponse";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<SubscribeToCertificateUpdatesResponse> shape(
                    Aws::Crt::New<SubscribeToCertificateUpdatesResponse>(allocator), SubscribeToCertificateUpdatesResponse::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SubscribeToCertificateUpdatesResponse::s_customDeleter(SubscribeToCertificateUpdatesResponse *shape) noexcept
            {
                AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
            }

            void SubscribeToCertificateUpdatesRequest::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
...
Aws::Crt::JsonObject certificateOptionsValue;
            ...
            void SubscribeToCertificateUpdatesRequest::s_loadFromJsonView(SubscribeToCertificateUpdatesRequest &subscribeToCertificateUpdatesRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("certificateOptions")) {
subscribeToCertificateUpdatesRequest.m_certificateOptions = CertificateOptions();
                    CertificateOptions::s_loadFromJsonView(subscribeToCertificateUpdatesRequest.m_certificateOptions.value(), jsonView.GetJsonObject("certificateOptions"));
                }
            }



            const char* SubscribeToCertificateUpdatesRequest::MODEL_NAME = "aws.greengrass#SubscribeToCertificateUpdatesRequest";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<SubscribeToCertificateUpdatesRequest> shape(
                    Aws::Crt::New<SubscribeToCertificateUpdatesRequest>(allocator), SubscribeToCertificateUpdatesRequest::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithString("message", m_message.value());
            ...
            void StopComponentResponse::s_loadFromJsonView(StopComponentResponse &stopComponentResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("stopStatus")) {
stopComponentResponse.m_stopStatus = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("stopStatus"));
                }
                if (jsonView.ValueExists("message")) {
stopComponentResponse.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
            ...
            {
                if (!m_stopStatus.has_value()) return Aws::Crt::Optional<RequestStatus>();
...
payloadObject.WithString("componentName", m_componentName.value());
            ...
            void StopComponentRequest::s_loadFromJsonView(StopComponentRequest &stopComponentRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
stopComponentRequest.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
            }
            ...
            void SendConfigurationValidityReportResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                (void)payloadObject;
            }

            void SendConfigurationValidityReportResponse::s_loadFromJsonView(SendConfigurationValidityReportResponse &sendConfigurationValidityReportResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
            ...
            const char* SendConfigurationValidityReportResponse::MODEL_NAME = "aws.greengrass#SendConfigurationValidityReportResponse";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<SendConfigurationValidityReportResponse> shape(
                    Aws::Crt::New<SendConfigurationValidityReportResponse>(allocator), SendConfigurationValidityReportResponse::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SendConfigurationValidityReportResponse::s_customDeleter(SendConfigurationValidityReportResponse *shape) noexcept
            {
                AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
            }

            void SendConfigurationValidityReportRequest::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
...
Aws::Crt::JsonObject configurationValidityReportValue;
            ...
            void SendConfigurationValidityReportRequest::s_loadFromJsonView(SendConfigurationValidityReportRequest &sendConfigurationValidityReportRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
sendConfigurationValidityReportRequest.m_configurationValidityReport = ConfigurationValidityReport();
                    ConfigurationValidityReport::s_loadFromJsonView(sendConfigurationValidityReportRequest.m_configurationValidityReport.value(), jsonView.GetJsonObject("configurationValidityReport"));
                }
            }



            const char* SendConfigurationValidityReportRequest::MODEL_NAME = "aws.greengrass#SendConfigurationValidityReportRequest";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<SendConfigurationValidityReportRequest> shape(
                    Aws::Crt::New<SendConfigurationValidityReportRequest>(allocator), SendConfigurationValidityReportRequest::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void SendConfigurationValidityReportRequest::s_customDeleter(SendConfigurationValidityReportRequest *shape) noexcept
            {
                AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
            }
            ...
            void ResumeComponentResponse::s_loadFromJsonView(ResumeComponentResponse &resumeComponentResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
payloadObject.WithString("componentName", m_componentName.value());
            ...
            void ResumeComponentRequest::s_loadFromJsonView(ResumeComponentRequest &resumeComponentRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
resumeComponentRequest.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
            }
...
payloadObject.WithString("message", m_message.value());
            ...
            void ComponentNotFoundError::s_loadFromJsonView(ComponentNotFoundError &componentNotFoundError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
...
payloadObject.WithString("message", m_message.value());
            ...
            void RestartComponentResponse::s_loadFromJsonView(RestartComponentResponse &restartComponentResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("restartStatus")) {
restartComponentResponse.m_restartStatus = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("restartStatus"));
                }
                if (jsonView.ValueExists("message")) {
restartComponentResponse.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
                }
            }
            ...
            {
                if (!m_restartStatus.has_value()) return Aws::Crt::Optional<RequestStatus>();
...
payloadObject.WithString("componentName", m_componentName.value());
            ...
            void RestartComponentRequest::s_loadFromJsonView(RestartComponentRequest &restartComponentRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
restartComponentRequest.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
            }
            ...
            void PublishToTopicResponse::s_loadFromJsonView(PublishToTopicResponse &publishToTopicResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
Aws::Crt::JsonObject publishMessageValue;
            ...
            void PublishToTopicRequest::s_loadFromJsonView(PublishToTopicRequest &publishToTopicRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("topic")) {
...
publishToTopicRequest.m_publishMessage = PublishMessage();
                    PublishMessage::s_loadFromJsonView(publishToTopicRequest.m_publishMessage.value(), jsonView.GetJsonObject("publishMessage"));
                }
            }
            ...
            void PublishToIoTCoreResponse::s_loadFromJsonView(PublishToIoTCoreResponse &publishToIoTCoreResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
if (m_payload.value().size() > 0) {
            ...
            void PublishToIoTCoreRequest::s_loadFromJsonView(PublishToIoTCoreRequest &publishToIoTCoreRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("topicName")) {
publishToIoTCoreRequest.m_topicName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("topicName"));
                }
                if (jsonView.ValueExists("qos")) {
publishToIoTCoreRequest.m_qos = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("qos"));
                ...
                if (jsonView.ValueExists("payload")) {
if (jsonView.GetString("payload").size() > 0) {
                        publishToIoTCoreRequest.m_payload = Aws::Crt::Optional<Aws::Crt::Vector<uint8_t>>(Aws::Crt::Base64Decode(jsonView.GetString("payload")));
                    }
                }
            }
            ...
            void PauseComponentResponse::s_loadFromJsonView(PauseComponentResponse &pauseComponentResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
payloadObject.WithString("componentName", m_componentName.value());
            ...
            void PauseComponentRequest::s_loadFromJsonView(PauseComponentRequest &pauseComponentRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
pauseComponentRequest.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
            }
...
payloadObject.WithString("nextToken", m_nextToken.value());
            ...
            void ListNamedShadowsForThingResponse::s_loadFromJsonView(ListNamedShadowsForThingResponse &listNamedShadowsForThingResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
listNamedShadowsForThingResponse.m_results = Aws::Crt::Vector<Aws::Crt::String>();
                ...
                if (jsonView.ValueExists("timestamp")) {
listNamedShadowsForThingResponse.m_timestamp = Aws::Crt::Optional<Aws::Crt::DateTime>(Aws::Crt::DateTime(jsonView.GetDouble("timestamp")));
                }
                if (jsonView.ValueExists("nextToken")) {
listNamedShadowsForThingResponse.m_nextToken = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("nextToken"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<ListNamedShadowsForThingResponse> shape(
                    Aws::Crt::New<ListNamedShadowsForThingResponse>(allocator), ListNamedShadowsForThingResponse::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithInteger("pageSize", m_pageSize.value());
            ...
            void ListNamedShadowsForThingRequest::s_loadFromJsonView(ListNamedShadowsForThingRequest &listNamedShadowsForThingRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("thingName")) {
listNamedShadowsForThingRequest.m_thingName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("thingName"));
                }
                if (jsonView.ValueExists("nextToken")) {
listNamedShadowsForThingRequest.m_nextToken = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("nextToken"));
                }
...
listNamedShadowsForThingRequest.m_pageSize = Aws::Crt::Optional<int>(jsonView.GetInteger("pageSize"));
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<ListNamedShadowsForThingRequest> shape(
                    Aws::Crt::New<ListNamedShadowsForThingRequest>(allocator), ListNamedShadowsForThingRequest::s_customDeleter);
                shape->m_allocator = allocator;
...
Aws::Crt::JsonObject listOfLocalDeployments;
            ...
            void ListLocalDeploymentsResponse::s_loadFromJsonView(ListLocalDeploymentsResponse &listLocalDeploymentsResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
listLocalDeploymentsResponse.m_localDeployments = Aws::Crt::Vector<LocalDeployment>();
                    ...
                    listOfLocalDeploymentsItem = LocalDeployment();
                        LocalDeployment::s_loadFromJsonView(listOfLocalDeploymentsItem.value(), listOfLocalDeploymentsJsonView);
                        listLocalDeploymentsResponse.m_localDeployments.value().push_back(listOfLocalDeploymentsItem.value());
                    }
                }
            }
            ...
            void ListLocalDeploymentsRequest::s_loadFromJsonView(ListLocalDeploymentsRequest &listLocalDeploymentsRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
Aws::Crt::JsonObject listOfComponents;
            ...
            void ListComponentsResponse::s_loadFromJsonView(ListComponentsResponse &listComponentsResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
listComponentsResponse.m_components = Aws::Crt::Vector<ComponentDetails>();
            ...
            void ListComponentsRequest::s_loadFromJsonView(ListComponentsRequest &listComponentsRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
if (m_payload.value().size() > 0) {
            ...
            void GetThingShadowResponse::s_loadFromJsonView(GetThingShadowResponse &getThingShadowResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("payload")) {
if (jsonView.GetString("payload").size() > 0) {
                        getThingShadowResponse.m_payload = Aws::Crt::Optional<Aws::Crt::Vector<uint8_t>>(Aws::Crt::Base64Decode(jsonView.GetString("payload")));
                    }
                }
            }
...
payloadObject.WithString("shadowName", m_shadowName.value());
            ...
            void GetThingShadowRequest::s_loadFromJsonView(GetThingShadowRequest &getThingShadowRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("thingName")) {
getThingShadowRequest.m_thingName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("thingName"));
                }
                if (jsonView.ValueExists("shadowName")) {
getThingShadowRequest.m_shadowName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("shadowName"));
                }
            }
...
Aws::Crt::JsonObject secretValueValue;
            ...
            void GetSecretValueResponse::s_loadFromJsonView(GetSecretValueResponse &getSecretValueResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("secretId")) {
getSecretValueResponse.m_secretId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("secretId"));
                }
                if (jsonView.ValueExists("versionId")) {
getSecretValueResponse.m_versionId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("versionId"));
                }
...
getSecretValueResponse.m_secretValue = SecretValue();
                    SecretValue::s_loadFromJsonView(getSecretValueResponse.m_secretValue.value(), jsonView.GetJsonObject("secretValue"));
                }
            }
...
payloadObject.WithString("versionStage", m_versionStage.value());
            ...
            void GetSecretValueRequest::s_loadFromJsonView(GetSecretValueRequest &getSecretValueRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("secretId")) {
getSecretValueRequest.m_secretId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("secretId"));
                }
                if (jsonView.ValueExists("versionId")) {
getSecretValueRequest.m_versionId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("versionId"));
                }
                if (jsonView.ValueExists("versionStage")) {
getSecretValueRequest.m_versionStage = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("versionStage"));
                }
            }
...
Aws::Crt::JsonObject localDeploymentValue;
            ...
            void GetLocalDeploymentStatusResponse::s_loadFromJsonView(GetLocalDeploymentStatusResponse &getLocalDeploymentStatusResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("deployment")) {
getLocalDeploymentStatusResponse.m_deployment = LocalDeployment();
                    LocalDeployment::s_loadFromJsonView(getLocalDeploymentStatusResponse.m_deployment.value(), jsonView.GetJsonObject("deployment"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<GetLocalDeploymentStatusResponse> shape(
                    Aws::Crt::New<GetLocalDeploymentStatusResponse>(allocator), GetLocalDeploymentStatusResponse::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithString("deploymentId", m_deploymentId.value());
            ...
            void GetLocalDeploymentStatusRequest::s_loadFromJsonView(GetLocalDeploymentStatusRequest &getLocalDeploymentStatusRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("deploymentId")) {
getLocalDeploymentStatusRequest.m_deploymentId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<GetLocalDeploymentStatusRequest> shape(
                    Aws::Crt::New<GetLocalDeploymentStatusRequest>(allocator), GetLocalDeploymentStatusRequest::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithObject("value", m_value.value());
            ...
            void GetConfigurationResponse::s_loadFromJsonView(GetConfigurationResponse &getConfigurationResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
getConfigurationResponse.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
                if (jsonView.ValueExists("value")) {
getConfigurationResponse.m_value = Aws::Crt::Optional<Aws::Crt::JsonObject>(jsonView.GetJsonObject("value").Materialize());
                }
            }
...
Aws::Crt::JsonObject keyPath;
            ...
            void GetConfigurationRequest::s_loadFromJsonView(GetConfigurationRequest &getConfigurationRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
getConfigurationRequest.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
                if (jsonView.ValueExists("keyPath")) {
...
Aws::Crt::JsonObject componentDetailsValue;
            ...
            void GetComponentDetailsResponse::s_loadFromJsonView(GetComponentDetailsResponse &getComponentDetailsResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentDetails")) {
getComponentDetailsResponse.m_componentDetails = ComponentDetails();
                    ComponentDetails::s_loadFromJsonView(getComponentDetailsResponse.m_componentDetails.value(), jsonView.GetJsonObject("componentDetails"));
                }
            }
...
payloadObject.WithString("componentName", m_componentName.value());
            ...
            void GetComponentDetailsRequest::s_loadFromJsonView(GetComponentDetailsRequest &getComponentDetailsRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("componentName")) {
getComponentDetailsRequest.m_componentName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("componentName"));
                }
            }
...
payloadObject.WithString("message", m_message.value());
            ...
            void InvalidCredentialError::s_loadFromJsonView(InvalidCredentialError &invalidCredentialError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
...
payloadObject.WithString("clientDeviceAuthToken", m_clientDeviceAuthToken.value());
            ...
            void GetClientDeviceAuthTokenResponse::s_loadFromJsonView(GetClientDeviceAuthTokenResponse &getClientDeviceAuthTokenResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("clientDeviceAuthToken")) {
getClientDeviceAuthTokenResponse.m_clientDeviceAuthToken = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("clientDeviceAuthToken"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<GetClientDeviceAuthTokenResponse> shape(
                    Aws::Crt::New<GetClientDeviceAuthTokenResponse>(allocator), GetClientDeviceAuthTokenResponse::s_customDeleter);
                shape->m_allocator = allocator;
...
Aws::Crt::JsonObject credentialDocumentValue;
            ...
            void GetClientDeviceAuthTokenRequest::s_loadFromJsonView(GetClientDeviceAuthTokenRequest &getClientDeviceAuthTokenRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("credential")) {
getClientDeviceAuthTokenRequest.m_credential = CredentialDocument();
                    CredentialDocument::s_loadFromJsonView(getClientDeviceAuthTokenRequest.m_credential.value(), jsonView.GetJsonObject("credential"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<GetClientDeviceAuthTokenRequest> shape(
                    Aws::Crt::New<GetClientDeviceAuthTokenRequest>(allocator), GetClientDeviceAuthTokenRequest::s_customDeleter);
                shape->m_allocator = allocator;
...
if (m_payload.value().size() > 0) {
            ...
            void DeleteThingShadowResponse::s_loadFromJsonView(DeleteThingShadowResponse &deleteThingShadowResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("payload")) {
if (jsonView.GetString("payload").size() > 0) {
                        deleteThingShadowResponse.m_payload = Aws::Crt::Optional<Aws::Crt::Vector<uint8_t>>(Aws::Crt::Base64Decode(jsonView.GetString("payload")));
                    }
                }
            }
...
payloadObject.WithString("shadowName", m_shadowName.value());
            ...
            void DeleteThingShadowRequest::s_loadFromJsonView(DeleteThingShadowRequest &deleteThingShadowRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("thingName")) {
deleteThingShadowRequest.m_thingName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("thingName"));
                }
                if (jsonView.ValueExists("shadowName")) {
deleteThingShadowRequest.m_shadowName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("shadowName"));
                }
            }
...
payloadObject.WithString("resourceName", m_resourceName.value());
            ...
            void ResourceNotFoundError::s_loadFromJsonView(ResourceNotFoundError &resourceNotFoundError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
...
resourceNotFoundError.m_resourceType = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("resourceType"));
                }
                if (jsonView.ValueExists("resourceName")) {
resourceNotFoundError.m_resourceName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("resourceName"));
                }
            }
            ...
            void DeferComponentUpdateResponse::s_loadFromJsonView(DeferComponentUpdateResponse &deferComponentUpdateResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
...
payloadObject.WithInt64("recheckAfterMs", m_recheckAfterMs.value());
            ...
            void DeferComponentUpdateRequest::s_loadFromJsonView(DeferComponentUpdateRequest &deferComponentUpdateRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("deploymentId")) {
deferComponentUpdateRequest.m_deploymentId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
                }
                if (jsonView.ValueExists("message")) {
deferComponentUpdateRequest.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
                }
                if (jsonView.ValueExists("recheckAfterMs")) {
deferComponentUpdateRequest.m_recheckAfterMs = Aws::Crt::Optional<int64_t>(jsonView.GetInt64("recheckAfterMs"));
                }
            }
            ...
            void InvalidArtifactsDirectoryPathError::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                if (m_message.has_value()) {
payloadObject.WithString("message", m_message.value());
                }
            ...
            void InvalidArtifactsDirectoryPathError::s_loadFromJsonView(InvalidArtifactsDirectoryPathError &invalidArtifactsDirectoryPathError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
invalidArtifactsDirectoryPathError.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<InvalidArtifactsDirectoryPathError> shape(
                    Aws::Crt::New<InvalidArtifactsDirectoryPathError>(allocator), InvalidArtifactsDirectoryPathError::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithString("message", m_message.value());
            ...
            void InvalidRecipeDirectoryPathError::s_loadFromJsonView(InvalidRecipeDirectoryPathError &invalidRecipeDirectoryPathError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
invalidRecipeDirectoryPathError.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<InvalidRecipeDirectoryPathError> shape(
                    Aws::Crt::New<InvalidRecipeDirectoryPathError>(allocator), InvalidRecipeDirectoryPathError::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithString("deploymentId", m_deploymentId.value());
            ...
            void CreateLocalDeploymentResponse::s_loadFromJsonView(CreateLocalDeploymentResponse &createLocalDeploymentResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("deploymentId")) {
createLocalDeploymentResponse.m_deploymentId = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<CreateLocalDeploymentResponse> shape(
                    Aws::Crt::New<CreateLocalDeploymentResponse>(allocator), CreateLocalDeploymentResponse::s_customDeleter);
                shape->m_allocator = allocator;
...
Aws::Crt::JsonObject componentToVersionMapValue;
                    ...
                    Aws::Crt::JsonObject componentToVersionMapJsonObject;
                        ...
                        componentToVersionMapValue.WithObject(componentToVersionMapItem.first, std::move(componentToVersionMapJsonObject));
                    }
...
Aws::Crt::JsonObject componentToConfigurationValue;
                    ...
                    Aws::Crt::JsonObject componentToConfigurationJsonObject;
                        ...
                        componentToConfigurationValue.WithObject(componentToConfigurationItem.first, std::move(componentToConfigurationJsonObject));
                    }
...
Aws::Crt::JsonObject componentToRunWithInfoValue;
                    ...
                    Aws::Crt::JsonObject componentToRunWithInfoJsonObject;
                        ...
                        componentToRunWithInfoValue.WithObject(componentToRunWithInfoItem.first, std::move(componentToRunWithInfoJsonObject));
                    }
...
payloadObject.WithString("artifactsDirectoryPath", m_artifactsDirectoryPath.value());
            ...
            void CreateLocalDeploymentRequest::s_loadFromJsonView(CreateLocalDeploymentRequest &createLocalDeploymentRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("groupName")) {
createLocalDeploymentRequest.m_groupName = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("groupName"));
                }
                if (jsonView.ValueExists("rootComponentVersionsToAdd")) {
createLocalDeploymentRequest.m_rootComponentVersionsToAdd = Aws::Crt::Map<Aws::Crt::String, Aws::Crt::String>();
                    for (const auto& componentToVersionMapPair : jsonView.GetJsonObject("rootComponentVersionsToAdd").GetAllObjects()) {
                        Aws::Crt::Optional<Aws::Crt::String> componentToVersionMapValue;
                    componentToVersionMapValue = Aws::Crt::Optional<Aws::Crt::String>(componentToVersionMapPair.second.AsString());
                        createLocalDeploymentRequest.m_rootComponentVersionsToAdd.value()[componentToVersionMapPair.first] = componentToVersionMapValue.value();
                    }
                }
...
createLocalDeploymentRequest.m_componentToConfiguration = Aws::Crt::Map<Aws::Crt::String, Aws::Crt::JsonObject>();
                    for (const auto& componentToConfigurationPair : jsonView.GetJsonObject("componentToConfiguration").GetAllObjects()) {
                        Aws::Crt::Optional<Aws::Crt::JsonObject> componentToConfigurationValue;
                    componentToConfigurationValue = Aws::Crt::Optional<Aws::Crt::JsonObject>(componentToConfigurationPair.second.AsObject().Materialize());
                        createLocalDeploymentRequest.m_componentToConfiguration.value()[componentToConfigurationPair.first] = componentToConfigurationValue.value();
                    }
                }
...
createLocalDeploymentRequest.m_componentToRunWithInfo = Aws::Crt::Map<Aws::Crt::String, RunWithInfo>();
                    for (const auto& componentToRunWithInfoPair : jsonView.GetJsonObject("componentToRunWithInfo").GetAllObjects()) {
                        Aws::Crt::Optional<RunWithInfo> componentToRunWithInfoValue;
                    componentToRunWithInfoValue = RunWithInfo();
                        RunWithInfo::s_loadFromJsonView(componentToRunWithInfoValue.value(), componentToRunWithInfoPair.second);
                        createLocalDeploymentRequest.m_componentToRunWithInfo.value()[componentToRunWithInfoPair.first] = componentToRunWithInfoValue.value();
                    }
                }
                if (jsonView.ValueExists("recipeDirectoryPath")) {
createLocalDeploymentRequest.m_recipeDirectoryPath = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("recipeDirectoryPath"));
                }
                if (jsonView.ValueExists("artifactsDirectoryPath")) {
createLocalDeploymentRequest.m_artifactsDirectoryPath = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("artifactsDirectoryPath"));
                }
            }
...
payloadObject.WithString("certificateSHA1Hash", m_certificateSHA1Hash.value());
            ...
            void CreateDebugPasswordResponse::s_loadFromJsonView(CreateDebugPasswordResponse &createDebugPasswordResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("password")) {
createDebugPasswordResponse.m_password = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("password"));
                }
                if (jsonView.ValueExists("username")) {
createDebugPasswordResponse.m_username = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("username"));
                }
                if (jsonView.ValueExists("passwordExpiration")) {
createDebugPasswordResponse.m_passwordExpiration = Aws::Crt::Optional<Aws::Crt::DateTime>(Aws::Crt::DateTime(jsonView.GetDouble("passwordExpiration")));
                }
                if (jsonView.ValueExists("certificateSHA256Hash")) {
createDebugPasswordResponse.m_certificateSHA256Hash = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("certificateSHA256Hash"));
                }
                if (jsonView.ValueExists("certificateSHA1Hash")) {
createDebugPasswordResponse.m_certificateSHA1Hash = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("certificateSHA1Hash"));
                }
            }
            ...
            void CreateDebugPasswordRequest::s_loadFromJsonView(CreateDebugPasswordRequest &createDebugPasswordRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
            ...
            void InvalidClientDeviceAuthTokenError::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                if (m_message.has_value()) {
payloadObject.WithString("message", m_message.value());
                }
            ...
            void InvalidClientDeviceAuthTokenError::s_loadFromJsonView(InvalidClientDeviceAuthTokenError &invalidClientDeviceAuthTokenError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
invalidClientDeviceAuthTokenError.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
                }
            }
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<InvalidClientDeviceAuthTokenError> shape(
                    Aws::Crt::New<InvalidClientDeviceAuthTokenError>(allocator), InvalidClientDeviceAuthTokenError::s_customDeleter);
                shape->m_allocator = allocator;
...
payloadObject.WithString("message", m_message.value());
            ...
            void InvalidArgumentsError::s_loadFromJsonView(InvalidArgumentsError &invalidArgumentsError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
...
payloadObject.WithString("message", m_message.value());
            ...
            void UnauthorizedError::s_loadFromJsonView(UnauthorizedError &unauthorizedError, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message")) {
unauthorizedError.m_message = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("message"));
            ...
            void AuthorizeClientDeviceActionResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
...
payloadObject.WithBool("isAuthorized", m_isAuthorized.value());
            ...
            void AuthorizeClientDeviceActionResponse::s_loadFromJsonView(AuthorizeClientDeviceActionResponse &authorizeClientDeviceActionResponse, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("isAuthorized")) {
authorizeClientDeviceActionResponse.m_isAuthorized = Aws::Crt::Optional<bool>(jsonView.GetBool("isAuthorized"));
                }
            }



            const char* AuthorizeClientDeviceActionResponse::MODEL_NAME = "aws.greengrass#AuthorizeClientDeviceActionResponse";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<AuthorizeClientDeviceActionResponse> shape(
                    Aws::Crt::New<AuthorizeClientDeviceActionResponse>(allocator), AuthorizeClientDeviceActionResponse::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            void AuthorizeClientDeviceActionRequest::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
            {
                if (m_clientDeviceAuthToken.has_value()) {
payloadObject.WithString("clientDeviceAuthToken", m_clientDeviceAuthToken.value());
                }
...
payloadObject.WithString("resource", m_resource.value());
            ...
            void AuthorizeClientDeviceActionRequest::s_loadFromJsonView(AuthorizeClientDeviceActionRequest &authorizeClientDeviceActionRequest, const Aws::Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("clientDeviceAuthToken")) {
authorizeClientDeviceActionRequest.m_clientDeviceAuthToken = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("clientDeviceAuthToken"));
                }
                if (jsonView.ValueExists("operation")) {
authorizeClientDeviceActionRequest.m_operation = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("operation"));
                }
                if (jsonView.ValueExists("resource")) {
authorizeClientDeviceActionRequest.m_resource = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("resource"));
                }
            }



            const char* AuthorizeClientDeviceActionRequest::MODEL_NAME = "aws.greengrass#AuthorizeClientDeviceActionRequest";
                ...
                Aws::Crt::Allocator *allocator) noexcept
            {
                ...
                Aws::Crt::ScopedResource<AuthorizeClientDeviceActionRequest> shape(
                    Aws::Crt::New<AuthorizeClientDeviceActionRequest>(allocator), AuthorizeClientDeviceActionRequest::s_customDeleter);
                shape->m_allocator = allocator;
            ...
            bool SubscribeToIoTCoreStreamHandler::OnStreamError(Aws::Crt::ScopedResource<OperationError> operationError,
                                                                        RpcError rpcError)
            {
                ...
                if (operationError != nullptr && operationError->GetModelName() == Aws::Crt::String("aws.greengrass#ServiceError") && !streamShouldTerminate) {
                    streamShouldTerminate = OnStreamError(static_cast<ServiceError*>(operationError.get()));
                }
                if (operationError != nullptr && operationError->GetModelName() == Aws::Crt::String("aws.greengrass#UnauthorizedError") && !streamShouldTerminate) {
                    streamShouldTerminate = OnStreamError(static_cast<UnauthorizedError*>(operationError.get()));
                }
                if (operationError != nullptr && !streamShouldTerminate) streamShouldTerminate = OnStreamError(operationError.get());
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> SubscribeToIoTCoreOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
            ...
            Aws::Crt::Optional<Aws::Crt::String> SubscribeToIoTCoreOperationContext::GetStreamingResponseModelName() const noexcept
            {
            ...
            std::future<SubscribeToIoTCoreResult> SubscribeToIoTCoreOperation::GetResult() noexcept
            {
                return std::async(std::launch::deferred, [this](){
                    return SubscribeToIoTCoreResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::Optional<Aws::Crt::String> ResumeComponentOperationContext::GetStreamingResponseModelName() const noexcept
            {
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return ResumeComponentResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> PublishToIoTCoreOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> PublishToIoTCoreOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return PublishToIoTCoreResult(GetOperationResult().get());
                });
            }
            ...
            void SubscribeToConfigurationUpdateStreamHandler::OnStreamEvent(Aws::Crt::ScopedResource<AbstractShapeBase> response)
            {
                OnStreamEvent(static_cast<ConfigurationUpdateEvents*>(response.get()));
            }

            bool SubscribeToConfigurationUpdateStreamHandler::OnStreamError(Aws::Crt::ScopedResource<OperationError> operationError,
                                                                        RpcError rpcError)
            {
                bool streamShouldTerminate = false;
                if (rpcError.baseStatus != EVENT_STREAM_RPC_SUCCESS) {
                ...
                if (operationError != nullptr && operationError->GetModelName() == Aws::Crt::String("aws.greengrass#ResourceNotFoundError") && !streamShouldTerminate) {
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> SubscribeToConfigurationUpdateOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> SubscribeToConfigurationUpdateOperationContext::GetStreamingResponseModelName() const noexcept
            {
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> DeleteThingShadowOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> DeleteThingShadowOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return DeleteThingShadowResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> DeferComponentUpdateOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> DeferComponentUpdateOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return DeferComponentUpdateResult(GetOperationResult().get());
                });
            }
            ...
            void SubscribeToValidateConfigurationUpdatesStreamHandler::OnStreamEvent(Aws::Crt::ScopedResource<AbstractShapeBase> response)
            {
                OnStreamEvent(static_cast<ValidateConfigurationUpdateEvents*>(response.get()));
            }

            bool SubscribeToValidateConfigurationUpdatesStreamHandler::OnStreamError(Aws::Crt::ScopedResource<OperationError> operationError,
                                                                        RpcError rpcError)
            {
                bool streamShouldTerminate = false;
                if (rpcError.baseStatus != EVENT_STREAM_RPC_SUCCESS) {
            ...
            SubscribeToValidateConfigurationUpdatesOperationContext::SubscribeToValidateConfigurationUpdatesOperationContext(
                const GreengrassCoreIpcServiceModel &serviceModel) noexcept
                : OperationModelContext(serviceModel)
            {
            }

            Aws::Crt::ScopedResource<AbstractShapeBase> SubscribeToValidateConfigurationUpdatesOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::String SubscribeToValidateConfigurationUpdatesOperationContext::GetInitialResponseModelName() const noexcept
            {
                return Aws::Crt::String("aws.greengrass#SubscribeToValidateConfigurationUpdatesResponse");
            }

            Aws::Crt::Optional<Aws::Crt::String> SubscribeToValidateConfigurationUpdatesOperationContext::GetStreamingResponseModelName() const noexcept
            {
            ...
            std::future<SubscribeToValidateConfigurationUpdatesResult> SubscribeToValidateConfigurationUpdatesOperation::GetResult() noexcept
            {
                return std::async(std::launch::deferred, [this](){
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> GetConfigurationOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> GetConfigurationOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return GetConfigurationResult(GetOperationResult().get());
                });
            }
            ...
            bool SubscribeToTopicStreamHandler::OnStreamError(Aws::Crt::ScopedResource<OperationError> operationError,
                                                                        RpcError rpcError)
            {
                bool streamShouldTerminate = false;
                if (rpcError.baseStatus != EVENT_STREAM_RPC_SUCCESS) {
                ...
                if (operationError != nullptr && operationError->GetModelName() == Aws::Crt::String("aws.greengrass#InvalidArgumentsError") && !streamShouldTerminate) {
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> SubscribeToTopicOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> SubscribeToTopicOperationContext::GetStreamingResponseModelName() const noexcept
            {
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return SubscribeToTopicResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> GetComponentDetailsOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> GetComponentDetailsOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return GetComponentDetailsResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> GetClientDeviceAuthTokenOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> GetClientDeviceAuthTokenOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            Aws::Crt::Optional<Aws::Crt::String> PublishToTopicOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return PublishToTopicResult(GetOperationResult().get());
                });
            }
            ...
            void SubscribeToCertificateUpdatesStreamHandler::OnStreamEvent(Aws::Crt::ScopedResource<AbstractShapeBase> response)
            {
                OnStreamEvent(static_cast<CertificateUpdateEvent*>(response.get()));
            }

            bool SubscribeToCertificateUpdatesStreamHandler::OnStreamError(Aws::Crt::ScopedResource<OperationError> operationError,
                                                                        RpcError rpcError)
            {
                bool streamShouldTerminate = false;
                if (rpcError.baseStatus != EVENT_STREAM_RPC_SUCCESS) {
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> SubscribeToCertificateUpdatesOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> SubscribeToCertificateUpdatesOperationContext::GetStreamingResponseModelName() const noexcept
            {
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> VerifyClientDeviceIdentityOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> VerifyClientDeviceIdentityOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> AuthorizeClientDeviceActionOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> AuthorizeClientDeviceActionOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            Aws::Crt::Optional<Aws::Crt::String> ListComponentsOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return ListComponentsResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> CreateDebugPasswordOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> CreateDebugPasswordOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return CreateDebugPasswordResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::Optional<Aws::Crt::String> GetThingShadowOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return GetThingShadowResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> SendConfigurationValidityReportOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> SendConfigurationValidityReportOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            std::future<SendConfigurationValidityReportResult> SendConfigurationValidityReportOperation::GetResult() noexcept
            {
                return std::async(std::launch::deferred, [this](){
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> UpdateThingShadowOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> UpdateThingShadowOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return UpdateThingShadowResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> UpdateConfigurationOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> UpdateConfigurationOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return UpdateConfigurationResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> ValidateAuthorizationTokenOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> ValidateAuthorizationTokenOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> RestartComponentOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> RestartComponentOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return RestartComponentResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> GetLocalDeploymentStatusOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> GetLocalDeploymentStatusOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            Aws::Crt::Optional<Aws::Crt::String> GetSecretValueOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return GetSecretValueResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> UpdateStateOperationContext::
                AllocateStreamingResponseFromPayload(Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator)
                    const noexcept
            {
                (void)stringView;
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return UpdateStateResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> ListNamedShadowsForThingOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> ListNamedShadowsForThingOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            void SubscribeToComponentUpdatesStreamHandler::OnStreamEvent(Aws::Crt::ScopedResource<AbstractShapeBase> response)
            {
                OnStreamEvent(static_cast<ComponentUpdatePolicyEvents*>(response.get()));
            }

            bool SubscribeToComponentUpdatesStreamHandler::OnStreamError(Aws::Crt::ScopedResource<OperationError> operationError,
                                                                        RpcError rpcError)
            {
                bool streamShouldTerminate = false;
                if (rpcError.baseStatus != EVENT_STREAM_RPC_SUCCESS) {
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> SubscribeToComponentUpdatesOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> SubscribeToComponentUpdatesOperationContext::GetStreamingResponseModelName() const noexcept
            {
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> ListLocalDeploymentsOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> ListLocalDeploymentsOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return ListLocalDeploymentsResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> StopComponentOperationContext::
                AllocateStreamingResponseFromPayload(Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator)
                    const noexcept
            {
                (void)stringView;
            ...
            Aws::Crt::Optional<Aws::Crt::String> StopComponentOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return StopComponentResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::Optional<Aws::Crt::String> PauseComponentOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            {
                return std::async(std::launch::deferred, [this](){
                    return PauseComponentResult(GetOperationResult().get());
                });
            }
            ...
            Aws::Crt::ScopedResource<AbstractShapeBase> CreateLocalDeploymentOperationContext::AllocateInitialResponseFromPayload(
                Aws::Crt::StringView stringView,
                Aws::Crt::Allocator *allocator) const noexcept
            {
            ...
            Aws::Crt::Optional<Aws::Crt::String> CreateLocalDeploymentOperationContext::GetStreamingResponseModelName() const noexcept
            {
                return Aws::Crt::Optional<Aws::Crt::String>();
            }
            ...
            GreengrassCoreIpcServiceModel::GreengrassCoreIpcServiceModel() noexcept :
                m_subscribeToIoTCoreOperationContext(*this),
                m_resumeComponentOperationContext(*this),
                m_publishToIoTCoreOperationContext(*this),
                m_subscribeToConfigurationUpdateOperationContext(*this),
                m_deleteThingShadowOperationContext(*this),
                m_deferComponentUpdateOperationContext(*this),
                m_subscribeToValidateConfigurationUpdatesOperationContext(*this),
                m_getConfigurationOperationContext(*this),
                m_subscribeToTopicOperationContext(*this),
                m_getComponentDetailsOperationContext(*this),
                m_getClientDeviceAuthTokenOperationContext(*this),
                m_publishToTopicOperationContext(*this),
                m_subscribeToCertificateUpdatesOperationContext(*this),
                m_verifyClientDeviceIdentityOperationContext(*this),
                m_authorizeClientDeviceActionOperationContext(*this),
                m_listComponentsOperationContext(*this),
                m_createDebugPasswordOperationContext(*this),
                m_getThingShadowOperationContext(*this),
                m_sendConfigurationValidityReportOperationContext(*this),
                m_updateThingShadowOperationContext(*this),
                m_updateConfigurationOperationContext(*this),
                m_validateAuthorizationTokenOperationContext(*this),
                m_restartComponentOperationContext(*this),
                m_getLocalDeploymentStatusOperationContext(*this),
                m_getSecretValueOperationContext(*this),
                m_updateStateOperationContext(*this),
                m_listNamedShadowsForThingOperationContext(*this),
                m_subscribeToComponentUpdatesOperationContext(*this),
                m_listLocalDeploymentsOperationContext(*this),
                m_stopComponentOperationContext(*this),
                m_pauseComponentOperationContext(*this),
            ...
            void GreengrassCoreIpcServiceModel::AssignModelNameToErrorResponse(Aws::Crt::String modelName,
