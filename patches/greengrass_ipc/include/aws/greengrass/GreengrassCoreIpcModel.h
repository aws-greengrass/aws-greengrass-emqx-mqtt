        ...
        namespace Aws {
            ...
            class ValidateConfigurationUpdateEvents : public AbstractShapeBase
            {
                public:
                    ...
                    ValidateConfigurationUpdateEvents(const ValidateConfigurationUpdateEvents &objectToCopy) { *this = objectToCopy; }
            ...
            class InvalidTokenError : public OperationError
            {
                public:
                    ...
                    static Aws::Crt::ScopedResource<OperationError> s_allocateFromPayload(Aws::Crt::StringView, Aws::Crt::Allocator *) noexcept;
            ...
            class SubscribeToValidateConfigurationUpdatesRequest : public AbstractShapeBase
            {
                public:
                    ...
                    /* This needs to be defined so that `SubscribeToValidateConfigurationUpdatesRequest` can be used as a key in maps. */
    ...
    bool OnStreamError(Aws::Crt::ScopedResource<OperationError> error, RpcError rpcError) override;
            ...
            class SubscribeToConfigurationUpdateResult
            {
              public:
                ...
                SubscribeToConfigurationUpdateResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
    ...
    bool OnStreamError(Aws::Crt::ScopedResource<OperationError> error, RpcError rpcError) override;
            ...
            class SubscribeToValidateConfigurationUpdatesResult
            {
              public:
                ...
                SubscribeToValidateConfigurationUpdatesResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
                SubscribeToValidateConfigurationUpdatesResponse *GetOperationResponse() const noexcept
                {
                    return static_cast<SubscribeToValidateConfigurationUpdatesResponse *>(m_taggedResult.GetOperationResponse());
                }
                /**
                  * @return true if the response is associated with an expected response;
                  * false if the response is associated with an error.
    ...
    bool OnStreamError(Aws::Crt::ScopedResource<OperationError> error, RpcError rpcError) override;
            ...
            class GetClientDeviceAuthTokenResult
            {
              public:
                ...
                GetClientDeviceAuthTokenResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
    ...
    bool OnStreamError(Aws::Crt::ScopedResource<OperationError> error, RpcError rpcError) override;
            ...
            class SubscribeToCertificateUpdatesResult
            {
              public:
                ...
                SubscribeToCertificateUpdatesResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
            ...
            class VerifyClientDeviceIdentityResult
            {
              public:
                ...
                VerifyClientDeviceIdentityResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
            ...
            class AuthorizeClientDeviceActionResult
            {
              public:
                ...
                AuthorizeClientDeviceActionResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
            ...
            class SendConfigurationValidityReportResult
            {
              public:
                ...
                SendConfigurationValidityReportResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
            ...
            class ValidateAuthorizationTokenResult
            {
              public:
                ...
                ValidateAuthorizationTokenResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
            ...
            class GetLocalDeploymentStatusResult
            {
              public:
                ...
                GetLocalDeploymentStatusResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
            ...
            class ListNamedShadowsForThingResult
            {
              public:
                ...
                ListNamedShadowsForThingResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
    ...
    bool OnStreamError(Aws::Crt::ScopedResource<OperationError> error, RpcError rpcError) override;
            ...
            class SubscribeToComponentUpdatesResult
            {
              public:
                ...
                SubscribeToComponentUpdatesResult(TaggedResult&& taggedResult) noexcept : m_taggedResult(std::move(taggedResult)) {}
            ...
            class GreengrassCoreIpcServiceModel : public ServiceModel
            {
              ...
              private:
                ...
                SubscribeToValidateConfigurationUpdatesOperationContext m_subscribeToValidateConfigurationUpdatesOperationContext;
