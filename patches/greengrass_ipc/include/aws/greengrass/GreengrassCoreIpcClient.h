        ...
        namespace Aws {
            ...
            class GreengrassCoreIpcClient
            {
              public:
                ...
                void Close() noexcept;
                std::shared_ptr<SubscribeToIoTCoreOperation> NewSubscribeToIoTCore(std::shared_ptr<SubscribeToIoTCoreStreamHandler> streamHandler) noexcept;
                ...
                std::shared_ptr<SubscribeToConfigurationUpdateOperation> NewSubscribeToConfigurationUpdate(std::shared_ptr<SubscribeToConfigurationUpdateStreamHandler> streamHandler) noexcept;
                ...
                std::shared_ptr<SubscribeToValidateConfigurationUpdatesOperation> NewSubscribeToValidateConfigurationUpdates(std::shared_ptr<SubscribeToValidateConfigurationUpdatesStreamHandler> streamHandler) noexcept;

                std::shared_ptr<GetConfigurationOperation> NewGetConfiguration() noexcept;

                std::shared_ptr<SubscribeToTopicOperation> NewSubscribeToTopic(std::shared_ptr<SubscribeToTopicStreamHandler> streamHandler) noexcept;
                ...
                std::shared_ptr<SubscribeToCertificateUpdatesOperation> NewSubscribeToCertificateUpdates(std::shared_ptr<SubscribeToCertificateUpdatesStreamHandler> streamHandler) noexcept;
                ...
                std::shared_ptr<SubscribeToComponentUpdatesOperation> NewSubscribeToComponentUpdates(std::shared_ptr<SubscribeToComponentUpdatesStreamHandler> streamHandler) noexcept;
